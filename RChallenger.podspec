...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shivaiah.mahesha@rakuten.com/RChallenger'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shivaiah.mahesha@rakuten.com' => 'shivaiah.mahesha@rakuten.com' }
  s.source           = { :git => 'https://github.com/shivaiah.mahesha@rakuten.com/RChallenger.git', :tag => s.version.to_s }
